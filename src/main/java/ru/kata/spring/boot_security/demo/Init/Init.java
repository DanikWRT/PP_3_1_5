...
public class Init {
    ...
    private void initializedDataBase() {
        ...
        User admin = new User("adminchik", "100", "admin@kata.ru", "Администратор", "Админский");
        User admin2 = new User("admin", "admin", "admin@kata.ru", "АдминистраторВсеяАдминов", "Админский");
        User user1 = new User("user", "user", "user@kata.ru", "Пользователь", "Такойто");
        User user2 = new User("Пользовалка", "100", "userka@kata.ru", "Пользовалка", "Такаята");
